...
```
Убедиться что nginx работает корректно можно набрав _арес.нашего.компьютера_ или _ip_ нашего сервера в браузере. Должна отображаться страница: ***`Welcome to nginx on Debian!`***
...
Убеждаемся, что nginx запущен снова набрав _арес.нашего.компьютера)_ или _ip_ нашего сервера в браузере. Если мы устанавливали версию из исходников, то убедиться, что работает имено она можно набрав команду:
```bash
nginx -v
```
Получим сообщение:
